  ...
  Future<bool?> pengajuanKredit(
    ...
    try {
      ...
      final msg = jsonEncode({
        ...
        "besar_pengajuan": besarPengajuan,
        "pekerjaan": pekerjaan,
        "gaji": gaji,
      ...
      var response =
          await http.post(Uri.parse(baseUrl! + '/api/pengajuankredit'),
              headers: {
                'X-API-Key': "myfin",
      ...
      child: ElevatedButton(
        onPressed: _value == true
            ? () async {
                ...
                SharedPreferences prefspenganjuan =
                    await SharedPreferences.getInstance();
                ...
                String resultBesarPengajuan =
                    besarPengajuanNilai.replaceAll(RegExp('[^0-9]'), '');
                String besarPendapatantambahan = widget.valuePendapatanTambahan;
                String resultPendapatantambahan =
                    besarPendapatantambahan.replaceAll(RegExp('[^0-9]'), '');
                ...
                bool? pengajuan = await pengajuanKredit(
                    id!,
                    penggunaan!,
                    pengajuanint!,
                    pekerjaan,
