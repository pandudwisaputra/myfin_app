...
class _PertanyaanState extends State<Pertanyaan> {
  ...
  Future<bool?> pertanyaanKeamanan(
    int id,
    String pertanyaan,
    String jawaban,
  ) async {
    try {
      ...
      var response = await http.put(
          Uri.parse(baseUrl! + '/api/keamanannasabah/' + id.toString()),
          headers: {
            'X-API-Key': "myfin",
  ...
  buildButton() {
    return RawMaterialButton(
      onPressed: () async {
        ...
        bool? data =
            await pertanyaanKeamanan(id!, pertanyaankeamanan!, jawaban);
        ...
        if (data == true) {
          ...
          showDialog(
              ...
              builder: (context) => const AlertDialog(
                    title: const Text("Gagal Set Keamanan"),
                  ));
        }
