                            ...
                            ConstrainedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  String resultjumlahPenarikan = jumlahPenarikan
                                      .replaceAll(RegExp('[^0-9]'), '');
                                  var jumlahPenarikanint =
                                      int.parse(resultjumlahPenarikan);
                                  ...
                                  if (jumlahPenarikanbool &&
                                    ...
                                    if (jumlahPenarikanint > saldo!) {
                                      ...
                                      if (datapenarikan == true) {
                                        var datapengurangan =
                                            await penguranganSaldo(
                                                id!, jumlahPenarikanint);
