import 'dart:convert';
import 'package:Myfin/helper/conecttion.dart';
import 'package:Myfin/helper/exception_handler.dart';
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets4.lottiefiles.com/packages/lf20_qszkkg7n.json',
                      width: 210,
                      height: 207),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets7.lottiefiles.com/packages/lf20_9s417nlp.json',
                      width: 250,
                      height: 247),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -5,
                  child: Lottie.network(
                      'https://assets3.lottiefiles.com/packages/lf20_4tiy5nnf.json',
                      width: 230,
                      height: 227),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -5,
                  child: Lottie.network(
                      'https://assets3.lottiefiles.com/packages/lf20_4gebyeyd.json',
                      width: 250,
                      height: 247),
                ),
              ],
...
Future keamananAkun(context) async {
  return showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => AlertDialog(
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets9.lottiefiles.com/packages/lf20_7fwvvesa.json',
                      width: 300,
                      height: 300),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets3.lottiefiles.com/packages/lf20_rdkzbvu0.json',
                      width: 300,
                      height: 300),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                Column(
                  children: [
                    Container(
                      ...
                      child: const Text(
                        "Email Kamu Sudah Terdaftar, Gunakan Email Lain",
                        style: TextStyle(
                            fontSize: 16,
                            fontFamily: 'Poppins',
                            color: Color.fromRGBO(53, 80, 210, 1)),
                ...
                Positioned(
                  top: 0,
                  child: Lottie.network(
                      'https://assets2.lottiefiles.com/packages/lf20_pqpmxbxp.json',
                      width: 200,
                      height: 180),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                Column(
                  children: [
                    Container(
                      ...
                      padding: const EdgeInsets.fromLTRB(20, 180, 20, 10),
                      child: const Text(
                        "Status Ajuan Kamu Masih Pending",
                        style: TextStyle(
                            fontSize: 16,
                            fontFamily: 'Poppins',
                            color: Color.fromRGBO(53, 80, 210, 1)),
                ...
                Positioned(
                  top: 0,
                  child: Lottie.network(
                      'https://assets8.lottiefiles.com/packages/lf20_dnp2c83r.json',
                      width: 200,
                      height: 180),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: 0,
                  child: Lottie.network(
                      'https://assets9.lottiefiles.com/packages/lf20_giodppcr.json',
                      width: 200,
                      height: 180),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -10,
                  child: Lottie.network(
                      'https://assets3.lottiefiles.com/packages/lf20_4jrhf7cm.json',
                      width: 150,
                      height: 160),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets10.lottiefiles.com/packages/lf20_vsbadcxj.json',
                      width: 250,
                      height: 260),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                Column(
                  children: [
                    Container(
                      ...
                      padding: const EdgeInsets.fromLTRB(20, 200, 20, 10),
                      child: const Text(
                        "Sukses Mengajukan Kredit, Tunggu Staff Memverifikasinya",
                        style: TextStyle(
                            fontSize: 16,
                            fontFamily: 'Poppins',
                            color: Color.fromRGBO(53, 80, 112, 1)),
                ...
                Positioned(
                  top: -10,
                  child: Lottie.network(
                      'https://assets5.lottiefiles.com/packages/lf20_vgiwpy5t.json',
                      width: 250,
                      height: 220),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                            ...
                            if (emailcheck == true) {
                              ...
                              showDialog(
                                  ...
                                  builder: (context) => const AlertDialog(
                                        title:
                                            const Text("Email Belum Terdaftar"),
                                      ));
                            }
                          },
                          child: const Text("OK"),
                ...
                Positioned(
                  top: 0,
                  child: Lottie.network(
                      'https://assets6.lottiefiles.com/packages/lf20_sat0coot.json',
                      width: 150,
                      height: 150),
                ),
              ],
            ...
            title: Stack(
              ...
              children: <Widget>[
                Column(
                  children: [
                    Container(
                      ...
                      padding: const EdgeInsets.fromLTRB(20, 200, 20, 10),
                      child: const Text(
                        "Sukses Mengajukan Penarikan, Tunggu Staff Memverifikasinya",
                        style: TextStyle(
                            fontSize: 16,
                            fontFamily: 'Poppins',
                            color: Color.fromRGBO(53, 80, 112, 1)),
                ...
                Positioned(
                  top: -40,
                  child: Lottie.network(
                      'https://assets8.lottiefiles.com/packages/lf20_q8mar8hq.json',
                      width: 300,
                      height: 300),
                ),
              ],
